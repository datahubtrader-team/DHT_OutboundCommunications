// import TestDbHelper from "../config/testDbHelper.js";
// import Product from "../src/models/outbound.js";
...
const fs = require('fs')
    //const mockUser = require('testfile.json');
...
describe('insert', () => {
    ...
    it('should insert a doc into collection', async() => {
        ...
        //let mockUser = JSON.parse(fs.readFileSync('testfile.json', 'utf-8'))
